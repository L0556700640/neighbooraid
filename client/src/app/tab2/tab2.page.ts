...
//#region try microphone
  ...
  //   } else {
  //     showInfo('start');
  //     console.log("good webkitSpeechRecognition");

  //     //todo: this.start_button.style.display = 'inline-block';
  //     const { webkitSpeechRecognition } = (<Window>window);
  //     this.recognition = new webkitSpeechRecognition();
  //     this.recognition.continuous = true;
  //     this.recognition.interimResults = true;

  //     this.recognition.onstart = this.currentMessage=function () {
  //       console.log("start record");
  //       this.recognizing = true;
  //        return showInfo('speak_now');
...
//   if (s) {
//       Tab2Page.messages[s];
//     // document.getElementById("info").innerHTML = message.msg;
//     //     $("#info").removeClass();
//     //     $("#info").addClass('alert');
