...
export class CasesService {
  ...
  getCurrentCase(id: String): Observable<String> {
   ...
   choseCaseAction(helpCallID,choosedCase,url):Observable<RelatedDoctorToCases>{
   return this.http.get<RelatedDoctorToCases>(environment.url +"Cases/CaseChose/"+helpCallID+"/"+choosedCase+"/"+url);
   }
}
